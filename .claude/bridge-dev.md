...
## Testing with Playwright and React
...
**Solution**: Use `page.keyboard.insertText()` with proper selection
...
**Important Notes**:
1. This issue only affects regular HTML inputs with React controlled state
...
4. Triple-click to select all is more reliable than keyboard shortcuts like `Control+a`

**Test File**: `web/e2e/critical-flows.spec.ts` - see "should successfully edit and save a document" test for working example

**Related Issue**: https://github.com/microsoft/playwright/issues/15813
