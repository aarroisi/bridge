defmodule Bridge.Assets do
  ...
  alias Bridge.Repo
  alias Bridge.Assets.Asset
  alias Bridge.Accounts.Workspace
  ...
  def delete_asset(%Asset{} = asset) do
    Repo.transaction(fn ->
      ...
      case Bridge.Storage.delete_object(asset.storage_key) do
        :ok -> :ok
        {:error, _reason} -> :ok
      end
