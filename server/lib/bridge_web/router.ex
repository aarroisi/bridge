defmodule BridgeWeb.Router do
  ...
  scope "/api", BridgeWeb do
    ...
    get("/lists/:list_id/statuses", ListStatusController, :index)
    post("/lists/:list_id/statuses", ListStatusController, :create)
    put("/lists/:list_id/statuses/reorder", ListStatusController, :reorder)
