      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="px-8 py-6 border-b border-dark-border">
          <input
            ...
            className="text-3xl font-bold text-dark-text bg-transparent border-none outline-none w-full mb-4"
          ...
          <div className="flex items-center gap-3 text-sm text-dark-text-muted">
            ...
            <span>•</span>
            <span>Created {format(new Date(doc.insertedAt), 'MMM d, yyyy')}</span>
